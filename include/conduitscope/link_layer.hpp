...
constexpr uint16_t ETHERTYPE_PPPOE_DISCOVERY = 0x8863;  // PPPoE Discovery stage, raw Ethernet, no IP -- see pppoe.hpp
constexpr uint16_t ETHERTYPE_PPPOE_SESSION = 0x8864;    // PPPoE Session stage, raw Ethernet, no IP -- see pppoe.hpp
...
constexpr uint16_t ETHERTYPE_POWERLINK = 0x88AB;  // Ethernet POWERLINK (EPSG), raw Ethernet, no IP
                                                    // -- see powerlink.hpp
