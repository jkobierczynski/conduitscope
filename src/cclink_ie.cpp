...
const std::unordered_map<uint16_t, std::string>& end_code_table() {
    static const std::unordered_map<uint16_t, std::string> table = {
        {0x0000, "success"},
        {0xC059, "command error"},
        {0xC05C, "command request message error"},
        {0xC61C, "request data length mismatch"},
        {0xCCC7, "CANopen: wrong condition"},
        {0xCCC8, "CANopen: write only"},
        {0xCCC9, "CANopen: read only"},
        {0xCCCA, "CANopen: object not defined"},
        {0xCCCB, "CANopen: PDO mapping not allowed"},
        {0xCCCC, "CANopen: PDO data length mismatch"},
        {0xCCD0, "CANopen: data value number mismatch"},
        {0xCCD1, "CANopen: data value number too large"},
        {0xCCD2, "CANopen: data value number too small"},
        {0xCCD3, "CANopen: subindex does not exist"},
        {0xCCD4, "CANopen: invalid parameter"},
        {0xCCD5, "CANopen: value too large"},
        {0xCCD6, "CANopen: value too small"},
        {0xCCDA, "CANopen: storing/transmitting impossible"},
        {0xCCFF, "CANopen: other error"},
        {0xCEE0, "request busy"},
        {0xCEE1, "request too large"},
        {0xCEE2, "response too large"},
        {0xCF00, "gateway error"},
        {0xCF10, "server information does not exist"},
        {0xCF20, "cannot be set"},
        {0xCF30, "parameter does not exist"},
        {0xCF31, "parameter writing in wrong state"},
        {0xCF40, "divided message timeout"},
        {0xCF41, "divided message duplicate"},
        {0xCF42, "divided message data error"},
        {0xCF43, "divided message lost"},
        {0xCF44, "divided message not supported"},
        {0xCF70, "communication relay error"},
        {0xCF71, "communication timeout"},
        {0xCFE0, "CCIEFB: master station duplication"},
        {0xCFE1, "CCIEFB: wrong number of occupied stations"},
        {0xCFF0, "CCIEFB: error in slave station"},
        {0xCFFF, "CCIEFB: disconnection notification from slave station"},
    };
    return table;
}
