...
const std::unordered_map<uint16_t, const char*>& mmtype_name_table() {
    static const std::unordered_map<uint16_t, const char*> table = {
        // Discovery
        {uint16_t{0x0014}, "CC_DISCOVER_LIST.REQ"},
        {uint16_t{0x0015}, "CC_DISCOVER_LIST.CNF"},
        {uint16_t{0x0016}, "CC_DISCOVER_LIST.IND"},
        // Bridging
        {uint16_t{0x6020}, "CM_BRG_INFO.REQ"},
        {uint16_t{0x6021}, "CM_BRG_INFO.CNF"},
        // Encryption/key management (security-relevant)
        {uint16_t{0x6006}, "CM_ENCRYPTED_PAYLOAD.IND"},
        {uint16_t{0x6007}, "CM_ENCRYPTED_PAYLOAD.RSP"},
        {uint16_t{0x6008}, "CM_SET_KEY.REQ"},
        {uint16_t{0x6009}, "CM_SET_KEY.CNF"},
        {uint16_t{0x600C}, "CM_GET_KEY.REQ"},
        {uint16_t{0x600D}, "CM_GET_KEY.CNF"},
        {uint16_t{0x6002}, "CM_UNASSOCIATED_STA.IND"},
        // Network/link stats
        {uint16_t{0x6038}, "CM_NW_INFO.REQ"},
        {uint16_t{0x6039}, "CM_NW_INFO.CNF"},
        {uint16_t{0x6048}, "CM_NW_STATS.REQ"},
        {uint16_t{0x6049}, "CM_NW_STATS.CNF"},
        {uint16_t{0x604C}, "CM_LINK_STATS.REQ"},
        {uint16_t{0x604D}, "CM_LINK_STATS.CNF"},
        // CCo election/management
        {uint16_t{0x0004}, "CC_BACKUP_APPOINT.REQ"},
        {uint16_t{0x0005}, "CC_BACKUP_APPOINT.CNF"},
        {uint16_t{0x0030}, "CC_ASSOC.REQ"},
        {uint16_t{0x0031}, "CC_ASSOC.CNF"},
        {uint16_t{0x002C}, "CC_WHO_RU.REQ"},
        {uint16_t{0x002D}, "CC_WHO_RU.CNF"},
        {uint16_t{0x0034}, "CC_LEAVE.REQ"},
        {uint16_t{0x0035}, "CC_LEAVE.CNF"},
        {uint16_t{0x0036}, "CC_LEAVE.IND"},
        {uint16_t{0x0037}, "CC_LEAVE.RSP"},
        {uint16_t{0x000C}, "CC_HANDOVER.REQ"},
        {uint16_t{0x000D}, "CC_HANDOVER.CNF"},
        {uint16_t{0x2000}, "CP_PROXY_APPOINT.REQ"},
        {uint16_t{0x2001}, "CP_PROXY_APPOINT.CNF"},
        {uint16_t{0x4000}, "NN_INL.REQ"},
        {uint16_t{0x4001}, "NN_INL.CNF"},
        {uint16_t{0x4004}, "NN_NEW_NET.REQ"},
        {uint16_t{0x4005}, "NN_NEW_NET.CNF"},
        {uint16_t{0x4006}, "NN_NEW_NET.IND"},
    };
    return table;
}
