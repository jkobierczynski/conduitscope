...
const std::unordered_map<uint16_t, const char*>& command_table() {
    static const std::unordered_map<uint16_t, const char*> table = {
        {uint16_t{0x0101}, "Memory Area Read"},
        {uint16_t{0x0102}, "Memory Area Write"},
        {uint16_t{0x0103}, "Memory Area Fill"},
        {uint16_t{0x0104}, "Multiple Memory Area Read"},
        {uint16_t{0x0401}, "Run"},
        {uint16_t{0x0402}, "Stop"},
        {uint16_t{0x0501}, "Controller Data Read"},
        {uint16_t{0x0601}, "Controller Status Read"},
        {uint16_t{0x0620}, "Cycle Time Read"},
        {uint16_t{0x0701}, "Clock Read"},
        {uint16_t{0x0702}, "Clock Write"},
        {uint16_t{0x0801}, "LOOP-BACK Test"},
        {uint16_t{0x0C01}, "Access Right Acquire"},
        {uint16_t{0x0C02}, "Access Right Forced Acquire"},
        {uint16_t{0x0C03}, "Access Right Release"},
        {uint16_t{0x2101}, "Error Clear"},
        {uint16_t{0x2301}, "Forced Set/Reset"},
        {uint16_t{0x2302}, "Forced Set/Reset Cancel"},
    };
    return table;
}
...
const std::unordered_map<uint16_t, const char*>& end_code_table() {
    static const std::unordered_map<uint16_t, const char*> table = {
        {uint16_t{0x0000}, "Normal completion"},
        {uint16_t{0x0001}, "Service was interrupted"},
        {uint16_t{0x0101}, "Local node not part of Network"},
        {uint16_t{0x0102}, "Token time-out, node number to large"},
        {uint16_t{0x0103}, "Number of transmit retries exceeded"},
        {uint16_t{0x0104}, "Maximum number of frames exceeded"},
        {uint16_t{0x0105}, "Node number setting error (range)"},
        {uint16_t{0x0106}, "Node number duplication error"},
        {uint16_t{0x0201}, "Destination node not part of Network"},
        {uint16_t{0x0202}, "No node with the specified node number"},
        {uint16_t{0x0203}, "Third node not part of Network : Broadcasting was specified"},
        {uint16_t{0x0204}, "Busy error, destination node busy"},
        {uint16_t{0x0205}, "Response time-out"},
        {uint16_t{0x0301}, "Error occurred : ERC indicator is lit"},
        {uint16_t{0x0302}, "CPU error occurred in the PC at the destination node"},
        {uint16_t{0x0303}, "A controller error has prevented a normal response"},
        {uint16_t{0x0304}, "Node number setting error"},
        {uint16_t{0x0401}, "An undefined command has been used"},
        {uint16_t{0x0402}, "Cannot process command because the specified unit model or version is wrong"},
        {uint16_t{0x0501}, "Destination node number is not set in the routing table"},
        {uint16_t{0x0502}, "Routing table isn't registered"},
        {uint16_t{0x0503}, "Routing table error"},
        {uint16_t{0x0504}, "Max relay nodes (2) was exceeded"},
        {uint16_t{0x1001}, "The command is longer than the max permissible length"},
        {uint16_t{0x1002}, "The command is shorter than the min permissible length"},
        {uint16_t{0x1003}, "The designated number of data items differs from the actual number"},
        {uint16_t{0x1004}, "An incorrect command format has been used"},
        {uint16_t{0x1005}, "An incorrect header has been used"},
        {uint16_t{0x1101}, "Memory area code invalid or DM is not available"},
        {uint16_t{0x1102}, "Access size is wrong in command"},
        {uint16_t{0x1103}, "First address in inaccessible area"},
        {uint16_t{0x1104}, "The end of specified word range exceeds acceptable range"},
        {uint16_t{0x1106}, "A non-existent program number"},
        {uint16_t{0x1109}, "The size of data items in command block are wrong"},
        {uint16_t{0x110A}, "The IOM break function cannot be executed"},
        {uint16_t{0x110B}, "The response block is longer than the max length"},
        {uint16_t{0x110C}, "An incorrect parameter code has been specified"},
        {uint16_t{0x2002}, "The data is protected"},
        {uint16_t{0x2003}, "Registered table does not exist"},
        {uint16_t{0x2004}, "Search data does not exist"},
        {uint16_t{0x2005}, "Non-existent program number"},
        {uint16_t{0x2006}, "Non-existent file"},
        {uint16_t{0x2007}, "Verification error"},
        {uint16_t{0x2101}, "Specified area is read-only"},
        {uint16_t{0x2102}, "The data is protected"},
        {uint16_t{0x2103}, "Too many files open"},
        {uint16_t{0x2105}, "Non-existent program number"},
        {uint16_t{0x2106}, "Non-existent file"},
        {uint16_t{0x2107}, "File already exists"},
        {uint16_t{0x2108}, "Data cannot be changed"},
        {uint16_t{0x2201}, "The mode is wrong (executing)"},
        {uint16_t{0x2202}, "The mode is wrong (stopped)"},
        {uint16_t{0x2203}, "The PC is in the PROGRAM mode"},
        {uint16_t{0x2204}, "The PC is in the DEBUG mode"},
        {uint16_t{0x2205}, "The PC is in the MONITOR mode"},
        {uint16_t{0x2206}, "The PC is in the RUN mode"},
        {uint16_t{0x2207}, "The specified node is not the control node"},
        {uint16_t{0x2208}, "The mode is wrong and the step cannot be executed"},
        {uint16_t{0x2301}, "The file device does not exist where specified"},
        {uint16_t{0x2302}, "The specified memory does not exist"},
        {uint16_t{0x2303}, "No clock exists"},
        {uint16_t{0x2401}, "Data link table is incorrect"},
        {uint16_t{0x2502}, "Parity / checksum error occurred"},
        {uint16_t{0x2503}, "I/O setting error"},
        {uint16_t{0x2504}, "Too many I/O points"},
        {uint16_t{0x2505}, "CPU bus error"},
        {uint16_t{0x2506}, "I/O duplication error"},
        {uint16_t{0x2507}, "I/O bus error"},
        {uint16_t{0x2509}, "SYSMAC BUS/2 error"},
        {uint16_t{0x250A}, "Special I/O Unit error"},
        {uint16_t{0x250D}, "Duplication in SYSMAC BUS word allocation"},
        {uint16_t{0x250F}, "A memory error has occurred"},
        {uint16_t{0x2510}, "Terminator not connected in SYSMAC BUS system"},
        {uint16_t{0x2601}, "The specified area is not protected"},
        {uint16_t{0x2602}, "An incorrect password has been specified"},
        {uint16_t{0x2604}, "The specified area is protected"},
        {uint16_t{0x2605}, "The service is being executed"},
        {uint16_t{0x2606}, "The service is not being executed"},
        {uint16_t{0x2607}, "Service cannot be execute from local node"},
        {uint16_t{0x2608}, "Service cannot be executed settings are incorrect"},
        {uint16_t{0x2609}, "Service cannot be executed incorrect settings in command data"},
        {uint16_t{0x260A}, "The specified action has already been registered"},
        {uint16_t{0x260B}, "Cannot clear error, error still exists"},
        {uint16_t{0x3001}, "The access right is held by another device"},
        {uint16_t{0x4001}, "Command aborted with ABORT command"},
    };
    return table;
}
