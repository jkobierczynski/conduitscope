...
int main(int argc, char** argv) {
    ...
    std::vector<int> decode_modbus_ports, decode_dnp3_ports, decode_s7comm_ports, decode_iec104_ports,
        ...
        decode_coap_ports, decode_rmcp_ports, decode_amqp_ports;
